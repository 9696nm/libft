...
SRC_DIR			=	./srcs
SRC_FILES		=	ft_isdigit.c ft_memset.c ft_strdup.c ft_strcmp.c ft_strncmp.c ft_atoi.c	ft_isprint.c \
					...
					ft_putbit.c ft_isspace.c ft_isvalue.c ft_split_toi.c ft_strtol.c\
